...
public class SnakeGame extends Application {
    ...
    // Increased width, kept height
    private static final int WIDTH = 20; // Increased width to 20
    private static final int HEIGHT = 15; // Kept height at 15
    ...
    public void start(Stage stage) {
        ...
        playAgainButton.setStyle("-fx-font-size: 40px; -fx-background-color: linear-gradient(#ff7f50, #ff6347); -fx-text-fill: white; -fx-padding: 10px 30px;");
        playAgainButton.setLayoutX(WIDTH * TILE_SIZE / 2 - 100); // Adjusted X position for wider window
        playAgainButton.setLayoutY(HEIGHT * TILE_SIZE / 2 + 30); // Adjusted Y position for shorter window
        ...
        backButton.setStyle("-fx-font-size: 20px; -fx-background-color: linear-gradient(#800080, #9932CC); -fx-text-fill: white; -fx-padding: 8px 16px;");

        backButton.setLayoutX(WIDTH * TILE_SIZE - 100); // Adjusted X position for wider window
        backButton.setLayoutY(HEIGHT * TILE_SIZE + 20); // Adjusted Y position for shorter window
    ...
    private void run(GraphicsContext gc) {
        if (gameOver) {
            ...
            gc.setFont(Font.font("Verdana", FontWeight.BOLD, 60)); // Reduced font size for smaller window
    ...
    private void drawScore(GraphicsContext gc) {
        ...
        gc.setFont(Font.font("Arial", FontWeight.BOLD, 30));  // Reduced font size for smaller window
        gc.fillText("Score: " + score, 10, HEIGHT * TILE_SIZE + 60); // Adjusted Y position
    }
